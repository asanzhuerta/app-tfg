...
\begin{itemize}
    \item \textbf{Asistente inteligente}: desarrollo de un diagnóstico capilar basado en \textbf{capilógrafo}. \textcolor{red}{TODO: revisar en la próxima reunión cómo citar correctamente la presentación de diagnóstico capilar consultada en Genially y confirmar si Oscar Vera Borja está de acuerdo en aparecer citado en el TFG.}
