...
Desde el punto de vista personal y académico, el proyecto también ha reforzado habilidades propias del trabajo de un ingeniero. Ha sido necesario investigar alternativas, contrastar fuentes, justificar decisiones, limitar el alcance cuando una funcionalidad crecía demasiado y diferenciar claramente entre lo implementado y lo planteado como trabajo futuro.
