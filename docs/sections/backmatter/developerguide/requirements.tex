...
\begin{itemize}
    \item \texttt{Visual Studio Code} para edición y depuracion;
...
\textcolor{red}{El proyecto no dispone todavía de una batería completa de tests funcionales automatizados}, de modo que estas comprobaciones deben acompasarse con validación manual de los flujos por rol.
