...
\begin{enumerate}
    ...
    \item \textbf{Comunicaciones multicanal.} Mostrar promociones con imagen/PDF, tipos de descuento, formaciones, avisos, activación de notificaciones del dispositivo y descuentos aplicados a pedido. Conviene explicar que el canal interno ya es la fuente principal y que correo SMTP y Web Push están implementados como canales opcionales, mientras que \textcolor{red}{\textit{WhatsApp} y los envíos planificados en segundo plano quedan como trabajo futuro}.
\end{enumerate}
