...
Las funciones previstas incluyen un \textbf{asistente inteligente de diagnóstico capilar} apoyado en el uso de un \textbf{capilógrafo}. \textcolor{red}{TODO: revisar en la próxima reunión cómo citar correctamente la presentación de diagnóstico capilar consultada en Genially y confirmar si Oscar Vera Borja está de acuerdo en aparecer citado en el TFG.} La intención es trasladar ese proceso a la aplicación e integrarlo con inteligencia artificial para proponer tratamientos o productos a partir de mediciones, observaciones técnicas, historial del cliente del salón y validación profesional.
