...
\tablecaption{Catálogo ejecutivo de requisitos no funcionales agrupado por características de calidad\label{tab:non-functional-requirements-executive}}
\tablefirsthead{%
\hline
...
\textbf{Característica} & \textbf{ID} & \textbf{Requisito no funcional sintetizado} \\
\hline}
\begin{supertabular}{|>{\raggedright\arraybackslash}p{0.17\linewidth}|>{\raggedright\arraybackslash}p{0.12\linewidth}|>{\raggedright\arraybackslash}p{0.62\linewidth}|}
