...
\begin{itemize}
    ...
    \item \textcolor{red}{La conexión directa con proveedores externos de mensajería, automatización empresarial o ERP real queda como evolución posterior sobre el inventario y las entidades persistidas.}
\end{itemize}
