...
En este módulo se han representado los casos de uso relacionados con administración e integraciones. El diagrama conserva el alcance objetivo del bloque: administración del sistema, consulta de información operativa, integración de servicios externos, sincronización con sistemas de gestión comercial, generación de pedidos a proveedor y propuesta automática de reposición. En la implementación real, la parte hoy desplegada cubre auditoría, configuración global de rate limiting, resumen operativo transversal, inventario operativo de integraciones de soporte, soporte transversal a servicios externos, soporte técnico de compatibilidad/PWA, registro persistente de integraciones empresariales, operaciones de exportación o sincronización y generación de propuestas de pedido a proveedor. \textcolor{red}{La automatización completa mediante \texttt{n8n}, Factusol, albaranes definitivos, facturación y reposición automática basada en rotación real queda documentada como evolución posterior del mismo alcance.}
