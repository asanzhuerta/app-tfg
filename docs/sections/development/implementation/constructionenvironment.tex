...
Además, la aplicación expone un \texttt{manifest} web propio mediante \path{app/manifest.ts}. Esto permite definir metadatos e iconos de instalación, aunque en el estado actual del proyecto no se ha incorporado una capa completa de caché offline ni un servicio \textit{PWA} dedicado.
