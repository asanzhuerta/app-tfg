...
Como evidencia visual específica del módulo \texttt{M6}, se han incorporado también capturas del centro administrativo de comunicaciones y de las vistas finales usadas por cliente y comercial. Estas pantallas muestran la publicación de promociones, el acceso a formaciones, las notificaciones internas, el indicador de avisos pendientes desde los paneles de rol y la conexión operativa entre promociones activas y pedidos con descuento aplicado.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Capturas reales del módulo M6 por perfil de usuario}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.30\textwidth}
        ...
        \caption{Avisos}
    \end{subfigure}
    \caption{Capturas reales de promociones, formaciones y avisos del módulo M6}
