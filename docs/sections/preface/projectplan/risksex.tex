La gestión de riesgos permite identificar posibles eventos que podrían afectar al desarrollo del proyecto, valorar su probabilidad e impacto y definir medidas preventivas o de contingencia. En este proyecto, los riesgos se han analizado teniendo en cuenta tanto el contexto académico como la complejidad técnica y funcional del sistema.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|L{0.9cm}|L{3.4cm}|L{2.5cm}|L{1.6cm}|Y|}
        ...
        \hline
        R1 & Ampliación excesiva del alcance funcional & Media & Alto & Priorizar una base funcional sólida y dejar módulos avanzados como trabajo futuro. \\
        \hline
        R2 & Cambios en los requisitos del cliente & Media & Medio & Mantener una definición modular del sistema y documentar claramente el alcance de la versión desarrollada. \\
        \hline
...
Una vez identificados los riesgos, se han aplicado dos estrategias principales. En primer lugar, se ha reducido el alcance implementado a un núcleo funcional viable, centrado en la base técnica del sistema. En segundo lugar, se han documentado las funcionalidades avanzadas e integraciones externas como parte de la evolución futura del proyecto.

Esta gestión permite mantener la viabilidad del Trabajo Fin de Grado sin perder la visión global del sistema propuesto.
